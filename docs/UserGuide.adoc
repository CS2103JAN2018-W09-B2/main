...
.  Login using the default username,`Admin` and default password, `ad123` by typing `login u/Admin pw/ad123`
+
.Login screen
...
image::UIMarkup.png[align="center" width="400" height="100"]
...
* **`add`**`add n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01 cp/Software Engineer cc/Garena` : adds a contact named `John Doe` to the Address Book.
