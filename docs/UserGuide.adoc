...
This section describes the commands you can use to secure your data stored in contactHeRo by the login system.
...
image::LogoutSuccess.png[width="800", align="center"]
...
.Success message after adding John Doe

image::addSuccess1.png[width="800", align="center"]
...
.Success message after adding Betsy Crowe
...
.Success message after editing John Doe
...
image::addSuccess2.png[width="800", align="center"]
...
.Screen after listing

image::listSuccess.png[width="800", align="center"]
...
.Screen after typing `find n/John`

image::findJohn.png[width="800", align="center"]
...
.Screen after typing `delete 1`

image::deleteJohn.png[width="800", align="center"]
...
.Screen after typing `listjob`

image::listjob.png[width="800", align="center"]
...
=== Utility Features
This section describes the commands you can use to utilize contactHeRo. +
